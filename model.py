...
class Generator(nn.Module):
    ...
    def forward(self, x, c_):
        ...
        x = self.residual_3(x, c_)
        x = self.residual_4(x, c_)
        x = self.residual_5(x, c_)
        x = self.residual_6(x, c_)
        x = self.residual_7(x, c_)
        x = self.residual_8(x, c_)
        x = self.residual_9(x, c_)
